...
const scrollActive = () =>{
    ...
    sections.forEach(current =>{
        ...
        // Safety check to ensure the link exists before trying to add class
        if(sectionsClass){
...
sr.reveal(`.home__data, .footer__container, .features__card`)
sr.reveal(`.home__img`, {origin: 'bottom', delay: 600})
sr.reveal(`.popular__card, .reviews__card`, {interval: 100})
